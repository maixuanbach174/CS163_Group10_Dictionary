...
TextList3::TextList3(sf::Color color)
{
    fontContents.loadFromFile("D:/SE/GroupProject/CS163_Group10_Dictionary/Fonts/arial.ttf");
    hover = color;
}

void TextList3::addText(wstring newText, int pos)
{
    ...
    buttonTemp->setSize(sf::Vector2f(1000.f, 55.f));
    buttonTemp->setFillColor(sf::Color::Transparent);

    textTemp->setPosition(sf::Vector2f(450.f, 197.f));
    buttonTemp->setPosition(sf::Vector2f(400.f, 190.f));
...
void TextList3::HandleTextList3Color(sf::Vector2i mousepos)
{
...
int TextList3::isInBound(sf::Vector2i mousepos)
{
...
void TextList3::removePos(int pos)
{
...
void TextList3::clearAll()
{
    contents.clear();
    buttons.clear();
}

void TextList3::moveText(sf::Vector2f delta)
{
...
int TextList3::findText(wstring text)
{
    for(int i = 0; i < contents.size(); ++i)
    {
...
void TextList3::removeText(wstring text)
{
